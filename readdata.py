def read_data(columns, types={} , filename="data/wxobs20170821.txt"):
    """
    Read data from CU Boulder Weather Station Data

    Parameters
        columns: A dictionary of column names mapping to column indices
        types: A dictionary of column names mapping to to which to
               convert each data column(otherwise they will be strings)
        filename:The string path pointing to the CU Weather Station data file
    """
